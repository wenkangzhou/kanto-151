...
function InviteDialog({ partner, previousId, expected, onClose }: { partner: Pokemon; previousId?: number | null; expected: number[]; onClose: () => void }) {
  ...
  async function confirm() {
    ...
    try { await saveTeam(next, expected); onClose(); }
