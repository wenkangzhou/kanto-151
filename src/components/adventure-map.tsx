...
export function AdventureMap({ snapshot }: { snapshot: CollectionSnapshot }) {
  ...
  return <section className="detail-panel adventure-map"><div className="section-heading"><h2><Compass size={24} /> 我们的冒险地图</h2><button className="text-link" onClick={() => setChosen(null)}><MapPin size={18} /> 回到这一站</button></div>
