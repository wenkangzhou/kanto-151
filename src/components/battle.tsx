...
import { ArrowLeft, RotateCcw, Swords, Trophy, Handshake, Shuffle } from 'lucide-react';
...
function Match({team,enemy,again,retry,canChange,audioOwner}:{team:number[];enemy:number;again:()=>void;retry:()=>void;canChange:boolean;audioOwner:string}) {
  ...
  function pick(){if(selected===null)return;dispatch({type:'choose',id:selected});setSelected(null);}
  return <>
